...
public class RenyuanService {
	 ...
	 */
	public static final RenyuanService me = new RenyuanService();
	 ...
	 */
	private Renyuan dao = new Renyuan().dao();
	
	public Page<Renyuan> paginate(int pageNumber, int pageSize) {
		return dao.paginate(pageNumber, pageSize, "select *", "from zhuhu order by id asc");
	}
	
	public Renyuan findById(String id) {

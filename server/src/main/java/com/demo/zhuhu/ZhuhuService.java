...
public class ZhuhuService {
	 ...
	 */
	public static final ZhuhuService me = new ZhuhuService();
	 ...
	 */
	private Zhuhu dao = new Zhuhu().dao();
	
	public Page<Zhuhu> paginate(int pageNumber, int pageSize) {
